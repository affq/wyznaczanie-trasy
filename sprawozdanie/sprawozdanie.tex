...
Używanie w heurystyce największej możliwej prędkości poruszania się powoduje, że algorytm analizuje więcej dróg. To sprawia że czas wyznaczenia trasy najszybszej jest dłuższy od czasu wyznaczenia trasy najkrótszej.
